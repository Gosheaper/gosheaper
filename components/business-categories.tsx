...
import Logo10 from "@/public/images/n8n-color.svg";
import Logo11 from "@/public/images/openai.svg";
import Logo12 from "@/public/images/openrouter.svg";
import Logo13 from "@/public/images/cursor.svg";
import Logo14 from "@/public/images/deepseek-color.svg";
import Logo15 from "@/public/images/meta-color.svg";
import Logo16 from "@/public/images/qwen-color.svg";
import Logo17 from "@/public/images/replit-color.svg";
import Logo18 from "@/public/images/trae-color.svg";
          ...
          <div className="relative flex h-[324px] items-center justify-center">
            ...
            <div className="relative flex flex-col">
              <article className="flex h-full w-full items-center justify-center focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-indigo-300">
                ...
                <div className="absolute -translate-x-[100px] -translate-y-[120px]">
                  <div className="animate-[breath_7s_ease-in-out_1s_infinite_both]">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo10}
                ...
                <div className="absolute translate-x-[100px] -translate-y-[120px]">
                  <div className="animate-[breath_7s_ease-in-out_1.5s_infinite_both]">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo11}
                ...
                <div className="absolute -translate-x-[350px] -translate-y-[60px]">
                  <div className="animate-[breath_6s_ease-in-out_0.5s_infinite_both]">
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo12}
                        width={22}
                ...
                <div className="absolute translate-x-[350px] -translate-y-[60px]">
                  <div className="animate-[breath_6s_ease-in-out_1s_infinite_both]">
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo13}
                ...
                <div className="absolute -translate-x-[320px] translate-y-[60px]">
                  <div className="animate-[breath_6s_ease-in-out_2s_infinite_both]">
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                ...
                <div className="absolute -translate-x-[250px] -translate-y-[180px]">
                  <div className="animate-[breath_7s_ease-in-out_0.5s_infinite_both]">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo16}
                        width={20}
                ...
                <div className="absolute translate-y-[180px] opacity-60">
                  <div className="animate-[breath_8s_ease-in-out_3s_infinite_both]">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg shadow-black/[0.03] before:absolute before:inset-0 before:m-[8.334%] before:rounded-[inherit] before:border before:border-gray-700/5 before:bg-gray-200/60 before:[mask-image:linear-gradient(to_bottom,black,transparent)]">
                      <Image
                        className="relative"
                        src={Logo18}
